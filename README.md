# Olá, eu sou o Guilherme Brito 👋

**Desenvolvedor Full Stack & Backend** focado em aplicações escaláveis, microsserviços e sustentação de software. Estudante de Engenharia de Software na UnB.

📍 Brasília, DF - Brasil | 💬 Português (Nativo) & Inglês (Fluente)

---

### 🚀 Sobre mim

- 💻 Atualmente focado em arquitetura de microsserviços, APIs RESTful e aplicações web modernas.
- 🛠️ Experiência prática com **Node.js, Python (FastAPI), C# (.NET)** no backend e **React / Next.js** no frontend.
- ☁️ Vivência em nuvem e DevOps utilizando **Docker, Azure Functions, Azure DevOps e CI/CD**.
- 🔍 Forte bagagem em **troubleshooting, análise de causa-raiz e sustentação de produtos** em produção.
